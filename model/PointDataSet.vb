...
Namespace model
    Public Class PointDataSet
        ...
        Public Sub New(point As PointObj, reactions As PointReactions, springProperty As SpringProperty)
            Me.point = point
            Me.reactions = reactions
			Me.springProperty = springProperty
        End Sub
        ...
        Public Overrides Function GetHashCode() As Integer
            ...
            Dim hash As Integer
            hash = Me.getPoint.GetHashCode + Me.getReactions.GetHashCode+ Me.getSpringProperty.GetHashCode
            Return hash
        End Function
        ...
        Public Overrides Function CompareTo(obj As Object) As Integer
            ...
            ElseIf Me.getSpringProperty.CompareTo(pdsObj.getSpringProperty)<> 0 then
				Return Me.getSpringProperty.CompareTo(pdsObj.getSpringProperty)
			End If
